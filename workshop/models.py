...
class WLiveWorkshopParticipants(models.Model):
    ...
    workshop_code = models.ForeignKey('WWorkshopRequests', db_column='workshop_code')
    foss_category = models.ForeignKey(FossCategories, db_column='name', related_name='foss_name')
    ...
    workshop_language = models.ForeignKey(TutorialLanguages, related_name='language_name')
