    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
            ],
            options={
                'verbose_name': 'New',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('city', models.ForeignKey(to='events.City', null=True, on_delete=models.deletion.PROTECT)),
                ('district', models.ForeignKey(to='events.District', null=True, on_delete=models.deletion.PROTECT)),
                ('location', models.ForeignKey(to='events.Location', null=True, on_delete=models.deletion.PROTECT)),
                ('state', models.ForeignKey(to='events.State', null=True, on_delete=models.deletion.PROTECT)),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visible', models.BooleanField()),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('nav', models.ForeignKey(to='cms.Nav', on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.AddField(
            model_name='news',
            name='news_type',
            field=models.ForeignKey(to='cms.NewsType', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='news',
            name='state',
            field=models.ForeignKey(blank=True, to='events.State', null=True, on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='block',
            name='block_location',
            field=models.ForeignKey(to='cms.Block_Location', on_delete=models.deletion.PROTECT),
        ),
    ]
