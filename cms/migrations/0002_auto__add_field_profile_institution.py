...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.institution'
        db.add_column(u'cms_profile', 'institution',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.AcademicCenter'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.institution'
        db.delete_column(u'cms_profile', 'institution_id')
    ...
    models = {
        ...
        'cms.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institution': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['events.AcademicCenter']", 'null': 'True'}),
