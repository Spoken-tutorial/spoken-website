    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(null=True, default=b'0', max_length=100, blank=True)),
                ('age_range', models.CharField(null=True, default=b'0', max_length=100, blank=True)),
                ('academic_code', models.CharField(null=True, default=b'0', max_length=100, blank=True)),
                ('organizer', models.CharField(null=True, default=b'0', max_length=100, blank=True)),
                ('invigilator', models.CharField(null=True, default=b'0', max_length=100, blank=True)),
                ('flag', models.CharField(null=True, default=b'0', max_length=100, blank=True)),
