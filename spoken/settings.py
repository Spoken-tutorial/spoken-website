...
DATABASES = {
    'default': {
        ...
        'PORT': '', 
        'TEST': {'NAME': 'test_spoken_11oct', 'USER': 'kirti', 'PASSWORD': 'kirti123', 'HOST': '', 'PORT': '',},                           # Set to empty string for default.
    },
    'moodle': {
        'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        ...
        'HOST': '',                  # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
        'PORT': '',
        'TEST': {'NAME': 'test_OTC', 'USER': 'kirti', 'PASSWORD': 'kirti123', 'HOST': '', 'PORT': '',},                 # Set to empty string for default.
    },
    # 'cdeep': {
    #     'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
