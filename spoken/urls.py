...
urlpatterns = patterns('',
    ...
    url(r'^series/$', 'spoken.views.other_foss', name="series"),
    ...
    url(r'^get-language/(?P<type>[\w-]+)/$', 'spoken.views.get_language', name="get_language"),
    ...
    # url(r'^learn-Drupal./$', 'spoken.views.learndrupal', name='learndrupal'),
    # url(r'^induction_old/$', 'spoken.views.induction_2017', name='induction_2017'),
    ...
    url(r'^induction/expression_of_intrest/$', 'spoken.views.expression_of_intrest', name='expression_of_intrest'),
    url(r'^induction/eoi/$', 'spoken.views.expression_of_intrest_new', name='expression_of_intrest_new'),
