    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(to='creation.Language', on_delete=models.deletion.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('playlist', models.ForeignKey(to='creation.PlaylistInfo', on_delete=models.deletion.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('foss_category', models.ForeignKey(to='creation.FossCategory', on_delete=models.deletion.PROTECT)),
                ('language', models.ForeignKey(to='creation.Language', on_delete=models.deletion.PROTECT)),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('approved_user', models.ForeignKey(related_name='approved_user', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.deletion.PROTECT)),
                ('user', models.ForeignKey(related_name='user', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='SuggestExample',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('difficulty_level', models.ForeignKey(to='creation.Level', on_delete=models.deletion.PROTECT)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('assignment_user', models.ForeignKey(related_name='assignments', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
                ('code_user', models.ForeignKey(related_name='codes', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
                ('keyword_user', models.ForeignKey(related_name='keywords', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('foss', models.ForeignKey(to='creation.FossCategory', on_delete=models.deletion.PROTECT)),
                ('level', models.ForeignKey(to='creation.Level', on_delete=models.deletion.PROTECT)),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('missing_component', models.ForeignKey(to='creation.TutorialMissingComponent', on_delete=models.deletion.PROTECT)),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('common_content', models.ForeignKey(to='creation.TutorialCommonContent', on_delete=models.deletion.PROTECT)),
                ('language', models.ForeignKey(to='creation.Language', on_delete=models.deletion.PROTECT)),
                ('outline_user', models.ForeignKey(related_name='outlines', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
                ('script_user', models.ForeignKey(related_name='scripts', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
                ('tutorial_detail', models.ForeignKey(to='creation.TutorialDetail', on_delete=models.deletion.PROTECT)),
                ('video_user', models.ForeignKey(related_name='videos', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.AddField(
            model_name='tutorialmissingcomponent',
            name='tutorial_resource',
            field=models.ForeignKey(to='creation.TutorialResource', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='tutorialmissingcomponent',
            name='user',
            field=models.ForeignKey(related_name='raised_user', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='tutorialcommoncontent',
            name='prerequisite',
            field=models.ForeignKey(related_name='prerequisite', blank=True, to='creation.TutorialDetail', null=True, on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='tutorialcommoncontent',
            name='prerequisite_user',
            field=models.ForeignKey(related_name='prerequisite', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='tutorialcommoncontent',
            name='slide_user',
            field=models.ForeignKey(related_name='slides', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='tutorialcommoncontent',
            name='tutorial_detail',
            field=models.OneToOneField(related_name='tutorial_detail', to='creation.TutorialDetail', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
