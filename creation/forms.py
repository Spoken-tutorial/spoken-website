...
class UploadBrochurebyCategory(forms.Form):
    '''category = forms.ChoiceField(
        choices=[('', '-- Select Foss Category--'), ] + list(FossSuperCategory.objects.all, language__name='English').values_list('category__primarycategory'),
        required=True,
        error_messages={'required': 'FOSS category type field is required.'}
    )'''
    category = forms.ChoiceField(
        choices=[('', '-- Select Foss Category--'), ] + list(FossSuperCategory.objects.all()),
        required=True,
