...
urlpatterns = patterns('',
        ...
        url(r'^view/ajax_upload_component/(?P<trid>\d+)/(?P<component>\w+)/$', 'creation.views.ajax_upload_component', name="ajax_upload_component"),
        ...
        url(r'^quality-review/tutorial/publish/youtube/$', 'creation.views.publish_tutorial_youtube', name="publish_tutorial_youtube"),
