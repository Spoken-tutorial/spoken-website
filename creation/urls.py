...
urlpatterns = patterns('',
    ...
    url(r'^revoke_allocated_tutorial/$', 'creation.views.revoke_allocated_tutorial', name="revoke_allocated_tutorial"),
    ...
    url(r'^get_rated_contributors/$', 'creation.views.get_rated_contributors', name="get_rated_contributors"),
    url(r'^update_contributors/$', 'creation.views.update_contributors', name="update_contributors"),
)
