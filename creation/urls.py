...
urlpatterns = [
    ...
    url(r'^domain-review/component/(\d+)/(\w+)/$', 'creation.views.domain_review_component',
        name="domain_review_component"),
    ...
    url(r'^quality-review/tutorial/publish/index/$', 'creation.views.publish_tutorial_index',
        name="publish_tutorial_index"),
    url(r'^quality-review/tutorial/publish/(\d+)/$', 'creation.views.publish_tutorial', name="publish_tutorial"),
    url(r'^quality-review/component/(\d+)/(\w+)/$', 'creation.views.quality_review_component',
        name="quality_review_component"),
    url(r'^public-review/tutorial/index/$', 'creation.views.public_review_tutorial_index',
        name="public_review_tutorial_index"),
    ...
    url(r'^public-review/mark-as-pending/(\d+)/$',
        'creation.views.public_review_mark_as_pending', name="public_review_mark_as_pending"),
    ...
    url(r'^role/requests/([a-zA-Z-]+)/$', 'creation.views.creation_list_role_requests',
        name="creation_list_role_requests"),
    ...
    url(r'^role/revoke/([a-zA-Z-]+)/$', 'creation.views.creation_revoke_role_request',
        name="creation_revoke_role_request"),
    url(r'^admin/tutorial/status/pending/$', 'creation.views.creation_change_published_to_pending',
        name="creation_change_published_to_pending"),
    url(r'^admin/tutorial/component/status/$', 'creation.views.creation_change_component_status',
        name="creation_change_component_status"),
    url(r'^ajax-publish-to-pending/$', 'creation.views.ajax_publish_to_pending', name="ajax_publish_to_pending"),
    url(r'^ajax-change-component-status/$', 'creation.views.ajax_change_component_status',
        name="ajax_change_component_status"),
    ...
    url(r'^delete-notification/(\w+)/(\d+)/$', 'creation.views.delete_creation_notification',
        name="delete_creation_notification"),
    url(r'^clear-notifications/(\w+)/$', 'creation.views.clear_creation_notification',
        name="clear_creation_notification"),
    url(r'^tutorial/view/([0-9a-zA-Z-+%\(\)]+)/([0-9a-zA-Z-+%\(\)]+)/([a-zA-Z-]+)/$',
        'creation.views.creation_view_tutorial', name="creation_view_tutorial"),
    ...
    url(r'^report-missing-component/(\d+)/$', 'creation.views.report_missing_component',
        name="report_missing_component"),
    url(r'^report-missing-component/reply/(\d+)/$',
        'creation.views.report_missing_component_reply', name="report_missing_component_reply"),
    url(r'^report-missing-component/list/$', 'creation.views.report_missing_component_list',
        name="report_missing_component_list"),
]
