...
urlpatterns = patterns('',
    ...
    url(r'^role/accept/(\d+)/(\d+)/$', 'creation.views.creation_accept_role_request', name="creation_accept_role_request"),
    url(r'^role/reject/(\d+)/(\d+)/$', 'creation.views.creation_reject_role_request', name="creation_reject_role_request"),
    url(r'^role/revoke/([a-zA-Z-]+)/([\d/]+)/$', 'creation.views.creation_revoke_role_request', name="creation_revoke_role_request"),
    ...
    url(r'^role/add/([a-zA-Z-]+)/([0-9/]+)/$', 'creation.views.creation_add_role', name="creation_add_role"),
    ...
    url(r'^allocate_foss/(?P<fid>\d+)/(?P<lang>\w+)/(?P<uid>\d+)/(?P<level>\w+)/(?P<date>\d{4}-\d{2}-\d{2})/$', 'creation.views.allocate_foss', name="allocate_foss"),
