...
urlpatterns = patterns('',
    ...
    url(r'^upload/tutorial/(\d+)/(\w+)/$', 'creation.views.upload_tutorial_action', name="upload_tutorial_action"),
    ...
    url(r'^view/component/(\d+)/(\w+)/(\w+)$', 'creation.views.view_component_audtype', name="view_component_audtype"),
