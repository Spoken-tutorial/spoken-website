...
from events2.decorators import group_required
from events2.forms import StudentBatchForm, TrainingRequestForm, TrainingRequestEditForm
...
class StudentDeleteView(DeleteView):
  model=Student
  def dispatch(self, *args, **kwargs):
    self.success_url="/events2/student-batch/"+str(kwargs['bid'])+"/view"
