...
from events.views import is_organiser, is_invigilator, is_resource_person, is_accountexecutive, \
    is_event_manager, can_clone_training, is_administrator, is_organiser_deactivated, is_invigilator_deactivated,is_school_training_manager
import datetime
