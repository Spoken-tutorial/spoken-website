...
class TrainingLanguageFeedbackForm(forms.ModelForm):
    ...
    medium_of_instruction = forms.ChoiceField(widget=forms.RadioSelect, choices = ((0, 'English'), (1, "Regional Language")) )
    gender = forms.ChoiceField(widget=forms.RadioSelect, choices = ((0, 'Male'), (1, "Female")) )
    language_preferred = forms.ChoiceField(widget=forms.RadioSelect, choices = ((0, 'English'), (0, 'Regional Language')))
    ...
    compfortable_learning_in_language = forms.ChoiceField(widget=forms.RadioSelect, choices = ((1, 'Not at all comfortable'), (2, 'Slightly comfortable'), (3, 'Somewhat comfortable'), (4, 'Very comfortable'), (5, 'Extremely comfortable')))
    confidence_level_in_language = forms.ChoiceField(widget=forms.RadioSelect, choices = ((1, 'Not at all confident'), (2, 'Slightly confident'), (3, 'Somewhat confident'), (4, 'Very confident'), (5, 'Extremely confident')))
    preferred_language = forms.ChoiceField(widget=forms.RadioSelect, choices = ((0, 'English'), (0, 'Regional Language')))
