...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrainingAttendance.mdluser_id'
        db.alter_column(u'events_trainingattendance', 'mdluser_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TrainingAttendance.mdluser_id'
        db.alter_column(u'events_trainingattendance', 'mdluser_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))
