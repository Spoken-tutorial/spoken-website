...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TrainingAttendance', fields ['training', 'mdluser_id']
        db.delete_unique(u'events_trainingattendance', ['training_id', 'mdluser_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'TrainingAttendance', fields ['training', 'mdluser_id']
        db.create_unique(u'events_trainingattendance', ['training_id', 'mdluser_id'])
