...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Training', fields ['organiser', 'academic', 'foss', 'trdate', 'trtime']
        db.delete_unique(u'events_training', ['organiser_id', 'academic_id', 'foss_id', 'trdate', 'trtime'])

        # Rename field 'Training.trdate' to 'Training.tdate'
        db.rename_column(u'events_training', 'trdate', 'tdate')

        # Rename field 'Training.trtime' to 'Training.ttime'
        db.rename_column(u'events_training', 'trtime', 'ttime')

        # Adding unique constraint on 'Training', fields ['organiser', 'academic', 'foss', 'tdate', 'ttime']
        db.create_unique(u'events_training', ['organiser_id', 'academic_id', 'foss_id', 'tdate', 'ttime'])


    def backwards(self, orm):
        # Removing unique constraint on 'Training', fields ['organiser', 'academic', 'foss', 'tdate', 'ttime']
        db.delete_unique(u'events_training', ['organiser_id', 'academic_id', 'foss_id', 'tdate', 'ttime'])

        # Rename field 'Training.trdate' to 'Training.tdate'
        db.rename_column(u'events_training', 'tdate', 'trdate')

        # Rename field 'Training.trtime' to 'Training.ttime'
        db.rename_column(u'events_training', 'ttime', 'trtime')

        # Adding unique constraint on 'Training', fields ['organiser', 'academic', 'foss', 'trdate', 'trtime']
        db.create_unique(u'events_training', ['organiser_id', 'academic_id', 'foss_id', 'trdate', 'trtime'])
    ...
    models = {
        ...
        u'events.training': {
            'Meta': {'unique_together': "(('organiser', 'academic', 'foss', 'tdate', 'ttime'),)", 'object_name': 'Training'},
            'academic': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['events.AcademicCenter']"}),
        ...
        u'events.trainingattendance': {
            'Meta': {'object_name': 'TrainingAttendance'},
            'count': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            'firstname': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'gender': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastname': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'mdluser_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
        ...
        u'events.trainingextrafields': {
            ...
            'no_of_lab_session': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'}),
        ...
        u'events.traininglanguagefeedback': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_prefered': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['creation.Language']", 'null': 'True'}),
