...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SchoolTrainingAttendance'
        db.delete_table(u'events_schooltrainingattendance')

        # Adding field 'TrainingAttendance.firstname'
        db.add_column(u'events_trainingattendance', 'firstname',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'TrainingAttendance.lastname'
        db.add_column(u'events_trainingattendance', 'lastname',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'TrainingAttendance.gender'
        db.add_column(u'events_trainingattendance', 'gender',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'TrainingAttendance.email'
        db.add_column(u'events_trainingattendance', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'SchoolTrainingAttendance'
        db.create_table(u'events_schooltrainingattendance', (
            ('status', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('training', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Training'])),
        ...
        db.send_create_signal(u'events', ['SchoolTrainingAttendance'])

        # Deleting field 'TrainingAttendance.firstname'
        db.delete_column(u'events_trainingattendance', 'firstname')

        # Deleting field 'TrainingAttendance.lastname'
        db.delete_column(u'events_trainingattendance', 'lastname')

        # Deleting field 'TrainingAttendance.gender'
        db.delete_column(u'events_trainingattendance', 'gender')

        # Deleting field 'TrainingAttendance.email'
        db.delete_column(u'events_trainingattendance', 'email')
