    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('academic', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='events.AcademicCenter')),
                ('appoved_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='invigilator_approved_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appoved_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='organiser_approved_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='permission_district', to='events.District', null=True)),
                ('institute', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='permission_district', to='events.AcademicCenter', null=True)),
                ('institute_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='permission_institution_type', to='events.InstituteType', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='PermissionType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('academic', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='events.AcademicCenter')),
                ('appoved_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='test_approved_by', to=settings.AUTH_USER_MODEL, null=True)),
                ('department', models.ManyToManyField(to='events.Department')),
                ('foss', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='creation.FossCategory')),
                ('invigilator', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='test_invigilator', to='events.Invigilator', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated', models.DateTimeField(auto_now=True, null=True)),
                ('approved_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='testimonial_approved_by', to=settings.AUTH_USER_MODEL, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('academic', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='events.AcademicCenter')),
                ('appoved_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='training_approved_by', to=settings.AUTH_USER_MODEL, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, default=None, to='creation.Language')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='events.Student')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('language_prefered', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='creation.Language', null=True)),
                ('training', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='events.Training')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('batch', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='events.StudentBatch', null=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='events.CourseMap')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='events.Department')),
        ...
        migrations.AddField(
            model_name='training',
            name='extra_fields',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, null=True, to='events.TrainingExtraFields'),
        ),
        migrations.AddField(
            model_name='training',
            name='foss',
        ...
        migrations.AddField(
            model_name='test',
            name='training',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='events.Training', null=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='permission',
            name='university',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='permission_iniversity', to='events.University', null=True),
        ),
        migrations.AddField(
            model_name='permission',
            name='user',
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, blank=True, to='events.LabCourse', null=True),
        ),
        migrations.AddField(
            model_name='coursemap',
            name='foss',
        ...
        migrations.AddField(
            model_name='academiccenter',
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='events.Location', null=True),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='state',
