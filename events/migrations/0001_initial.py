    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('academic', models.ForeignKey(to='events.AcademicCenter', on_delete=models.deletion.PROTECT)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('academic', models.ForeignKey(to='events.AcademicCenter',  on_delete=models.deletion.PROTECT)),
                ('appoved_by', models.ForeignKey(related_name='invigilator_approved_by', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.deletion.PROTECT)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appoved_by', models.ForeignKey(related_name='organiser_approved_by', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.deletion.PROTECT)),
                ('user', models.OneToOneField(related_name='organiser', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('assigned_by', models.ForeignKey(related_name='permission_assigned_by', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
                ('district', models.ForeignKey(related_name='permission_district', to='events.District', null=True, on_delete=models.deletion.PROTECT)),
                ('institute', models.ForeignKey(related_name='permission_district', to='events.AcademicCenter', null=True, on_delete=models.deletion.PROTECT)),
                ('institute_type', models.ForeignKey(related_name='permission_institution_type', to='events.InstituteType', null=True, on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='PermissionType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic', models.ForeignKey(to='events.AcademicCenter',  on_delete=models.deletion.PROTECT)),
                ('course', models.ForeignKey(to='events.CourseMap', on_delete=models.deletion.PROTECT)),
                ('language', models.ForeignKey(to='creation.Language', on_delete=models.deletion.PROTECT)),
                ('organiser', models.ForeignKey(to='events.Organiser', on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField()),
                ('updated', models.DateTimeField()),
                ('training', models.ForeignKey(to='events.SingleTraining', on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='State',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic', models.ForeignKey(to='events.AcademicCenter', on_delete=models.deletion.PROTECT)),
                ('department', models.ForeignKey(to='events.Department', on_delete=models.deletion.PROTECT)),
                ('organiser', models.ForeignKey(to='events.Organiser', on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('batch', models.ForeignKey(to='events.StudentBatch', on_delete=models.deletion.PROTECT)),
                ('student', models.ForeignKey(to='events.Student', on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='Test',
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('academic', models.ForeignKey(to='events.AcademicCenter', on_delete=models.deletion.PROTECT)),
                ('appoved_by', models.ForeignKey(related_name='test_approved_by', to=settings.AUTH_USER_MODEL, null=True, on_delete=models.deletion.PROTECT)),
                ('department', models.ManyToManyField(to='events.Department')),
                ('foss', models.ForeignKey(to='creation.FossCategory', on_delete=models.deletion.PROTECT)),
                ('invigilator', models.ForeignKey(related_name='test_invigilator', to='events.Invigilator', null=True, on_delete=models.deletion.PROTECT)),
                ('organiser', models.ForeignKey(related_name='test_organiser', to='events.Organiser', on_delete=models.deletion.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('test', models.ForeignKey(to='events.Test', on_delete=models.deletion.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated', models.DateTimeField(auto_now=True, null=True)),
                ('approved_by', models.ForeignKey(related_name='testimonial_approved_by', to=settings.AUTH_USER_MODEL, null=True, on_delete=models.deletion.PROTECT)),
                ('user', models.ForeignKey(related_name='testimonial_created_by', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='TestLog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('academic', models.ForeignKey(to='events.AcademicCenter', on_delete=models.deletion.PROTECT)),
                ('appoved_by', models.ForeignKey(related_name='training_approved_by', to=settings.AUTH_USER_MODEL, null=True, on_delete=models.deletion.PROTECT)),
                ('course', models.ForeignKey(to='events.Course', on_delete=models.deletion.PROTECT)),
                ('department', models.ManyToManyField(to='events.Department')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('language', models.ForeignKey(default=None, to='creation.Language', on_delete=models.deletion.PROTECT)),
                ('student', models.ForeignKey(to='events.Student', on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('training', models.ForeignKey(to='events.Training', on_delete=models.deletion.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('language_prefered', models.ForeignKey(to='creation.Language', null=True, on_delete=models.deletion.PROTECT)),
                ('training', models.ForeignKey(to='events.Training', on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic', models.ForeignKey(to='events.AcademicCenter', on_delete=models.deletion.PROTECT)),
                ('organiser', models.ForeignKey(to='events.Organiser', on_delete=models.deletion.PROTECT)),
                ('semester', models.ForeignKey(to='events.Semester', on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('batch', models.ForeignKey(to='events.StudentBatch', null=True, on_delete=models.deletion.PROTECT)),
                ('course', models.ForeignKey(to='events.CourseMap', on_delete=models.deletion.PROTECT)),
                ('department', models.ForeignKey(to='events.Department', on_delete=models.deletion.PROTECT)),
                ('training_planner', models.ForeignKey(to='events.TrainingPlanner', on_delete=models.deletion.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='University',
        ...
        migrations.AddField(
            model_name='training',
            name='extra_fields',
            field=models.OneToOneField(null=True, to='events.TrainingExtraFields', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='training',
            name='foss',
        ...
        migrations.AddField(
            model_name='training',
            name='organiser',
            field=models.ForeignKey(to='events.Organiser', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='test',
            name='test_category',
            field=models.ForeignKey(related_name='test_category', to='events.TestCategory', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='test',
            name='training',
            field=models.ForeignKey(to='events.Training', null=True, on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='resourceperson',
            name='state',
            field=models.ForeignKey(to='events.State', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='resourceperson',
            name='user',
        ...
        migrations.AddField(
            ...
            name='permissiontype',
            field=models.ForeignKey(to='events.PermissionType', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='permission',
            name='state',
            field=models.ForeignKey(related_name='permission_state', to='events.State', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='permission',
            name='university',
            field=models.ForeignKey(related_name='permission_iniversity', to='events.University', null=True, on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='permission',
            name='user',
            field=models.ForeignKey(related_name='permission_user', to=settings.AUTH_USER_MODEL, on_delete=models.deletion.PROTECT),
        ),
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(blank=True, to='events.LabCourse', null=True, on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='coursemap',
            name='foss',
        ...
        migrations.AddField(
            ...
            name='city',
            field=models.ForeignKey(to='events.City', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='district',
            field=models.ForeignKey(to='events.District', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='institute_category',
            field=models.ForeignKey(to='events.InstituteCategory', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='institution_type',
            field=models.ForeignKey(to='events.InstituteType', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='location',
            field=models.ForeignKey(to='events.Location', null=True, on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='state',
        ...
        migrations.AddField(
            model_name='academiccenter',
            name='university',
            field=models.ForeignKey(to='events.University', on_delete=models.deletion.PROTECT),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='user',
