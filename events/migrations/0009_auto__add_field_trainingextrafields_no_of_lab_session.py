...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainingExtraFields.no_of_lab_session'
        db.add_column(u'events_trainingextrafields', 'no_of_lab_session',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainingExtraFields.no_of_lab_session'
        db.delete_column(u'events_trainingextrafields', 'no_of_lab_session')
