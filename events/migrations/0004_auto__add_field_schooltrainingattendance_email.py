...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SchoolTrainingAttendance.email'
        db.add_column(u'events_schooltrainingattendance', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SchoolTrainingAttendance.email'
        db.delete_column(u'events_schooltrainingattendance', 'email')
