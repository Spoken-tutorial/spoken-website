...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainingLanguageFeedback.language_prefered'
        db.add_column(u'events_traininglanguagefeedback', 'language_prefered',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['creation.Language'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainingLanguageFeedback.language_prefered'
        db.delete_column(u'events_traininglanguagefeedback', 'language_prefered_id')
