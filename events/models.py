...
class STWorkshopFeedback(models.Model):
  ...
  dont_like_self_learning_method = models.CharField(max_length = 50, choices = OPINION)
  ...
  difficult_instructions_in_tutorial = models.CharField(max_length = 50, choices = OPINION)
  ...
  confident_to_apply_knowledge = models.CharField(max_length = 50, choices = OPINION)
  ...
  language_diff_to_understand = models.CharField(max_length = 50, choices = OPINION)
