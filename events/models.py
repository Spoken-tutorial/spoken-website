...
class STWorkshopFeedbackPost(models.Model):
  ...
  NUM_OF_EXPERTS_LENGTH = max(len(x[0]) for x in NUM_OF_EXPERTS)
  
  user = models.ForeignKey(User, on_delete=models.PROTECT )
  email = models.EmailField(max_length = 100)
  gender = models.CharField(max_length = 10, choices = GENDER_CHOICES)
  age = models.CharField(max_length = 2)
  participated_before = models.CharField(max_length = 3, choices = YES_NO_CHOICES)
  foss_where = models.CharField(max_length = 200)
  install_own = models.CharField(max_length = 3, choices = YES_NO_CHOICES)
  explain = models.TextField()
  used_sw_before = models.CharField(max_length = 3, choices = YES_NO_CHOICES)
  sim_framework_before = models.CharField(max_length = 3, choices = YES_NO_CHOICES)
  total_tutorials1 = models.CharField(max_length = 20)
  ...
  content_management = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  configuration_management = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  creating_basic_content = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  edit_existing_content = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  create_new_content = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  grp_entity_ref = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  taxonomy = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  managing_content = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  creating_dummy_content = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)

  modify_display_content = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  contents_using_view = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  table_of_fields_with_views = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  control_display_images = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  adding_func = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  finding_modules = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  modifying_page_layout = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  menu_endpoints = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  styling_using_themes = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  installig_ad_themes = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  people_management = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)
  site_management = models.CharField(max_length = FEELINGS_MAX_LENGTH, choices = FEELINGS)

  ws_quality = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  relevance = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  guidelines = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  overall_video_quality = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  text_readability = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  clarity_of_speech = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  visual_presentation = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  pace_of_tutorial = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  arrangement = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  network = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  installation_help = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  time_for_handson = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  experience_of_learning = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)
  overall_arrangement = models.CharField(max_length = RATE_SPOKEN_CHOICES_LENGTH, choices = RATE_SPOKEN_CHOICES)



  like_to_create_st = models.CharField(max_length = 3, choices = YES_NO_CHOICES)
  like_to_create_st_details = models.TextField()
  num_of_experts_req = models.CharField(max_length = NUM_OF_EXPERTS_LENGTH, choices = NUM_OF_EXPERTS)
