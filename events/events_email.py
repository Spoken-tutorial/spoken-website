...
Regards,
Spoken Tutorial
'''.format('http://process.spoken-tutorial.org/images/c/c2/Participant_data.pdf', 'http://process.spoken-tutorial.org/images/1/1b/Download-Tutorials.pdf', 'http://process.spoken-tutorial.org/images/5/58/Machine-Readiness.pdf', instance.foss, instance.tdate, instance.ttime, instance.training_code)
...
Regards,
Spoken Tutorial
'''.format(instance.training_code, instance.foss, instance.tdate)
