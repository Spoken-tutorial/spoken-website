...
Thank you for making the Training / workshop request on {3} to be conducted at your Institute.
Please upload the "Participant List" of students who are expected to take part in the Training BEFORE
the Training / Workshop. The Training Manager at Spoken Tutorial Project Team, IIT Bombay will
only be able to approve your request if "Participant List" is Uploaded.

Please click on the following link to know the Instructions to upload the Participant Details :

{0}

Note: It is necessary that you upload the "Participant List" while you raise the Training / Workshop
Request, for the Training Manager to approve your request.

As soon as the Training Manager approves, you will get the Training / Workshop code {6}. This
code is very important, please preserve it for your future reference.

Please ensure that the students go through the instruction sheet and see the tutorials as directed in the
instructions mentioned in it and also practice the commands and instruction as shown in the tutorial
following the Side by Side method during the Training / workshop.

Side by Side means that on the screen, we keep the terminal/console window open on the right
hand side for the practice and the tutorial window open on the left hand side for the learning.

If you have clicked YES for Skype support then you can send us a request on our Skype ID namely
st-wshop and st-iitb. Any day before the Training / workshop please call us on Skype to have a Skype
testing session and interact with Spoken Tutorial, IIT Bombay team.
...
You have successfully completed the Workshop {0} on {1} at your institute. Please
see the following instructions for the future activities.

Recording Attendance

Please record (submit) your attendance by marking on the 'Participant List' which you have uploaded
while making the Workshop Request. To know more, click here http://process.spoken-
tutorial.org/images/5/5d/Recording_the_attendance_workshop.pdf

N.B.: Only after you submit the 'Participant List' with attendance marked, the participants can
download the Learner's Certificate.

Bulk Training / Workshops

Before starting the new semester we can do some planning so that we can start the training in the college
in a phased manner. If you have already prepared a Bulk workshop calendar in line with your lab hours or
curriculum please share it with me.

The following is the link which will navigate directly to the Sample Calendar page of our Wiki. See some
samples from other colleges.
http://process.spoken-tutorial.org/index.php/Software-Training#Sample_Calendar

    1. You need not arrange regular workshops for the softwares which are part of your lab
       course (C,C++, Java etc.) instead you can introduce Spoken Tutorials on these software
       courses to students directly during their respective lab hours.
       
    2. Ensure that the Spoken Tutorials are loaded into the systems in the labs in advance. This
       will make the learning very smooth.
       
    3. This will get off the responsibility and worry about lab availability and structured
       workshop timings.
...
After the workshop, the participants need to complete listening to all the tutorials and practise well
including solving the assignment questions. This revision needs to be done at least 2 times so that the
students are ready to take the online test. The organiser needs to keep a watch that proper revision is
being done. Total time taken can be anywhere from 2 weeks to 1 month or even more.

Fix the online test date after confirming that all students have practised well.

N.B.: If you have conducted a software Training session and made the course contents available
to the students during the regular lab hours throughout the semester where it matches with the
curriculum, then you can schedule the test during or before the end of the semester as per your
convenience.

Please note that an invigilator is required for the online test. For this, identify a faculty member who
can invigilate the test and help him/her register on the spoken-tutorial.org website before you make a
test request.
...
You have successfully completed the Training / Workshop {0} on {1} at your institute.
Please see the following instructions for the future activities.

Fill up Training Completion Form

Please complete the required details in the 'Training Completion Form' for the Training (WC-XX) on
(FOSS name) which you have started on (Date) and click on the 'Submit' button. To know more, click
here http://process.spoken-tutorial.org/images/0/04/Instruction_Training_completion_form.pdf

N.B.: Only after you fill and submit the 'Training Completion Form', the participants can download the
...
http://process.spoken-tutorial.org/index.php/Software-Training#Sample_Calendar
    ...
    3. This will get off the responsibility and worry about lab availability and structured
       workshop timings.
    4. Ensure that the Spoken Tutorials are loaded into the systems in the labs in advance. This
       will make the learning very smooth.
    5. This will get off the responsibility and worry about lab availability and structured
       workshop timingsself.
       
Kindly go through the link to understand the lab deployment process.

http://process.spoken-tutorial.org/images/7/72/Matching_spoken-tutorial.pdf

For other Software courses which are not part of the lab you can continue the workshop method used in
the last academic semester.
...
After the workshop, the participants need to complete listening to all the tutorials and practice well
including solving the assignment questions. This revision needs to be done at least 2 times so that the
students are ready to take the online test. The organiser needs to keep a watch that proper revision is
being done. Total time taken can be anywhere from 2 weeks to 1 month or even more.
