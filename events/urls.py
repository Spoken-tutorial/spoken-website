...
urlpatterns = patterns('',
    ...
    url(r'^training/participant/language-feedback/(\d+)/(\d+)/$', 'events.views.training_participant_language_feedback', name='training_participant_language_feedback'),
    ...
    url(r'^yaksh/advance_tests/approve/rp/(?P<test_id>\d+)/$', 'events.views.advance_test_approve_rp', name='advance_test_approve_rp'),
    url(r'^yaksh/advance_tests/reject/rp/(?P<test_id>\d+)/$', 'events.views.advance_test_reject_rp', name='advance_test_reject_rp'),
    url(r'^yaksh/advance_tests/as_rp/$', 'events.views.advance_tests_rp', name='advance_tests_rp'),
    url(r'^yaksh/advance_tests/as_rp/(?P<status>\d+)/$', 'events.views.advance_tests_rp', name='advance_tests_rp'),
    url(r'^yaksh/advance_tests/approve/iv/(?P<test_id>\d+)/$', 'events.views.advance_test_approve_iv', name='advance_test_approve_iv'),
    url(r'^yaksh/advance_tests/reject/iv/(?P<test_id>\d+)/$', 'events.views.advance_test_reject_iv', name='advance_test_reject_iv'),
    url(r'^yaksh/advance_tests/as_iv/$', 'events.views.advance_tests_iv', name='advance_tests_iv'),
    url(r'^yaksh/advance_tests/as_iv/(?P<status>\d+)/$', 'events.views.advance_tests_iv', name='advance_tests_iv'),
    url(r'^yaksh/advance_tests/as_org/$', 'events.views.advance_tests_org', name='advance_tests_org'),
    url(r'^yaksh/advance_tests/as_org/(?P<status>\d+)/$', 'events.views.advance_tests_org', name='advance_tests_org'),
    ...
    url(r'ajax-check-foss/$', 'events.views.ajax_check_foss', name='ajax_check_foss'),
